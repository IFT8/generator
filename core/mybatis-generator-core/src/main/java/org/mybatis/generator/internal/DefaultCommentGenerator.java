...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        author = properties.getProperty(PropertyRegistry.COMMENT_GENERATOR_AUTHOR);
    }
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass.addJavaDocLine(" * Created by "+ author +" on "+ getNowDateString() +".");
        innerClass.addJavaDocLine(" */");
    }
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        topLevelClass.addJavaDocLine(" * Created by "+ author +" on "+ getNowDateString() +".");
        topLevelClass.addJavaDocLine(" */");
    }
    ...
    public void addFieldComment(Field field,
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            ...
            for (String remarkLine : remarkLines) {
                sb.append(" ").append(remarkLine);  //$NON-NLS-1$
            }
        }
